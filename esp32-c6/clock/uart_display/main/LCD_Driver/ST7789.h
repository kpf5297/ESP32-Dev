...
// The pixel number in horizontal and vertical (landscape mode)
...
// ST7789 controller is typically 240x320; this 172x320 panel uses a centered window.
// After landscape rotation (swap_xy), the active 320x172 area is centered in 320x240.
#define Offset_X 0
#define Offset_Y 34
